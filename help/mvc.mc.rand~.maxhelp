...
, 			{
				"box" : 				{
					...
					"text" : "mvc.helpfiller mvc.mc.rand~"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.mc.rand~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 287.3599853515625, 57.599853515625 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 21.5, 329.0, 130.0, 130.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 406.5, 298.483109919571007, 136.0, 39.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "mvc.remote MCrandHelper/myFunkyrand/channel.1/frequency"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.5, 283.5, 238.0, 35.0 ],
									"text" : "mvc.mc.rand~ MCrandHelper myFunkyrand",
									"varname" : "mvc.biquad~"
								}
