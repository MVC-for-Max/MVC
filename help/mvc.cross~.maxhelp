...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.cross~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 227.215988159179688, 57.599853515625 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"parameter_enable" : 1,
									"patching_rect" : [ 22.5, 421.5, 118.0, 42.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 347.0, 477.5, 122.0, 51.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 347.0, 345.0, 122.0, 51.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 378.0, 327.0, 64.0, 21.0 ],
									"text" : "highpass"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 398.5, 463.0, 19.0, 21.0 ],
									"text" : "="
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 378.0, 393.5, 67.0, 21.0 ],
									"text" : "+ lowpass"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "multichannelsignal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 145.0, 366.0, 118.0, 42.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 655.5, 112.0, 32.0, 22.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 543.5, 278.5, 127.0, 52.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 467.5, 75.0, 207.0, 29.0 ],
									"text" : "mvc.device crossHelper",
									"varname" : "mvc.device"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 347.0, 412.5, 122.0, 51.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 514.5, 327.972654155495775, 215.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "multichannelsignal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 22.5, 366.0, 118.0, 42.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.5, 465.5, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mvc.cross~ crossHelper myFunkyCross",
									"varname" : "mvc.biquad~"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-40", 0 ],
									"midpoints" : [ 154.5, 409.75, 32.0, 409.75 ],
									"source" : [ "obj-22", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 32.0, 356.0, 332.0, 356.0, 332.0, 403.0, 356.5, 403.0 ],
									"order" : 1,
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 154.5, 334.25, 356.5, 334.25 ],
									"order" : 1,
									"source" : [ "obj-3", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 154.5, 340.0, 343.0, 340.0, 343.0, 468.0, 356.5, 468.0 ],
									"order" : 0,
									"source" : [ "obj-3", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-39", 0 ],
									"midpoints" : [ 32.0, 360.0, 328.0, 360.0, 328.0, 470.0, 356.5, 470.0 ],
									"order" : 0,
									"source" : [ "obj-3", 0 ]
								}
