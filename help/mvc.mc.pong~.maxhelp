...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 175.0, 120.0, 22.0 ],
					"text" : "jsargs mvc.mc.pong~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 195.0, 155.0, 22.0 ],
					"text" : "mvc.helpfiller mvc.mc.pong~"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.mc.pong~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 265.42401123046875, 57.599853515625 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 21.5, 314.0, 130.0, 130.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 394.5, 300.516890080428993, 111.0, 39.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 537.5, 77.5, 221.0, 29.0 ],
									"text" : "mvc.device MCpongHelper",
									"varname" : "mvc.device"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 21.5, 235.5, 132.0, 35.0 ],
									"text" : "mc.phasor~ @chans 3 @values 1 2 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 293.5, 258.0, 174.0, 22.0 ],
									"text" : "param channel.1/DCblocker $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 340.5, 321.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 340.5, 349.516890080428993, 153.0, 49.0 ],
									"text" : "mvc.remote MCpongHelper/myFunkypong/channel.1/DCblocker"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mvc.mc.pong~ MCpongHelper myFunkypong",
									"varname" : "mvc.biquad~"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 350.0, 409.516890080428993, 332.0, 409.516890080428993, 332.0, 310.0, 350.0, 310.0 ],
									"source" : [ "obj-6", 0 ]
								}
