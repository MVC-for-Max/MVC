...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.GUI.activeToggle" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 440.887969970703125, 57.599853515625 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 439.0, 280.0, 217.0, 24.0 ],
									"text" : "this monitors the parameter below"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 313.0, 237.0, 296.0, 37.0 ],
									"text" : "this monitors the mvc.device's internal \"ON\" parameter. Open its GUI to see the connection."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 86.0, 387.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 133.0, 242.5, 178.0, 22.0 ],
									"text" : "address activeToggleHelper/ON"
								}
