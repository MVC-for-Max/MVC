...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 175.0, 121.0, 22.0 ],
					"text" : "jsargs mvc.pitchshift~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 195.0, 156.0, 22.0 ],
					"text" : "mvc.helpfiller mvc.pitchshift~"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.pitchshift~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 317.47998046875, 57.599853515625 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 407.5, 306.5, 111.0, 39.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 419.977072310405674, 138.457306582306558, 198.0, 37.0 ],
													"text" : "or use the dedicated GUI objects by providing them a path"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 399.977072310405674, 144.957306582306558, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 399.977072310405674, 186.957306582306558, 237.0, 22.0 ],
													"text" : "address pitchshiftHelper/myFunkypitchshift"
												}
...
, 											{
												"box" : 												{
													...
													"offset" : [ 0.0, 0.0 ],
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 393.977072310405674, 266.957306582306558, 301.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"offset" : [ 0.0, 0.0 ],
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 533.977072310405674, 238.957306582306558, 139.0, 23.0 ],
													"viewvisibility" : 1
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 409.477072310405674, 229.457306582306558, 663.477072310405674, 229.457306582306558 ],
													"order" : 1,
													"source" : [ "obj-14", 0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 409.477072310405674, 221.457306582306558, 685.477072310405674, 221.457306582306558 ],
													"order" : 0,
													"source" : [ "obj-14", 0 ]
												}
...
,
									"patching_rect" : [ 218.0, 248.5, 58.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 304.5, 288.0, 51.0, 22.0 ],
									"text" : "chans 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 713.5, 255.5, 32.0, 22.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 355.5, 209.0, 131.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 300.5, 162.5, 150.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 508.5, 218.5, 224.0, 29.0 ],
									"text" : "mvc.device pitchshiftHelper",
									"varname" : "mvc.device"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.5, 378.5, 207.0, 55.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 291.5, 216.5, 62.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 291.5, 248.5, 110.0, 22.0 ],
									"text" : "param pitchshift $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 273.5, 174.0, 30.0, 22.0 ],
									"text" : "GUI"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 388.0, 351.483109919571007, 215.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 388.0, 374.0, 305.0, 22.0 ],
									"text" : "mvc.remote pitchshiftHelper/myFunkypitchshift/pitchshift"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 21.5, 388.5, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 21.5, 283.5, 271.0, 22.0 ],
									"text" : "mvc.pitchshift~ pitchshiftHelper myFunkypitchshift",
									"varname" : "mvc.biquad~"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 397.5, 406.0, 377.5, 406.0, 377.5, 340.483109919571007, 397.5, 340.483109919571007 ],
									"source" : [ "obj-6", 0 ]
								}
