...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 175.0, 96.0, 35.0 ],
					"text" : "jsargs mvc.rand~"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.rand~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 213.632003784179688, 57.599853515625 ]
				}
...
, 							{
								"box" : 								{
									...
									"text" : "mvc.remote randHelper/myFunkyrand/frequency"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mvc.rand~ randHelper myFunkyrand",
									"varname" : "mvc.biquad~"
								}
