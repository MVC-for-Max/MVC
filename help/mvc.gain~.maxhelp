...
, 			{
				"box" : 				{
					...
					"text" : "mvc.helpfiller mvc.gain~ @tags component"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"ignoreclick" : 1,
					"jsarguments" : [ "mvc.gain~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 206.144012451171875, 57.599853515625 ]
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 383.5, 354.0, 215.0, 16.0 ],
									"setminmax" : [ -72.0, 6.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 401.0, 293.5, 127.0, 52.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 294.5, 283.0, 85.0, 22.0 ],
									"text" : "param gain $1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "mvc.gain~ gainHelper myGain",
									"varname" : "mvc.limiter~"
								}
