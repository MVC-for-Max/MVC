...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 357.0, 35.0, 22.0 ],
					"text" : "r test"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.602756500244141, 332.5, 37.0, 22.0 ],
					"text" : "s test"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 391.602756500244141, 305.0, 43.0, 22.0 ],
					"text" : "print --"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 299.602756500244141, 36.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 310.602756500244141, 94.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.602756500244141, 204.0, 150.0, 22.0 ],
					"text" : "replace address yop, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.602756500244141, 299.0, 75.0, 22.0 ],
					"text" : "prepend test"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.602756500244141, 174.0, 179.0, 22.0 ],
					"text" : "replace address whatever, bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 289.602756500244141, 236.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 423.0, 235.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 1,
						"defer" : 0,
						"node_bin_path" : "",
...
,
					"text" : "node.script mvc.test-async.js @autostart 1"
				}
...
, 			{
				"name" : "mvc.test-async.js",
				"bootpath" : "~/Documents/Max 8/Packages/MVC/tests/test-async",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
