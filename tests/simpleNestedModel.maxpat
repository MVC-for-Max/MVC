...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 320.0, 122.0, 135.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 342.0, 272.0, 142.0, 22.0 ],
									"text" : "address what none whup"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 782.0, 391.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 777.0, 427.0, 32.0, 22.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 721.0, 506.0, 198.0, 22.0 ],
									"text" : "address toto/myModel/modelParam"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 700.0, 463.0, 32.0, 22.0 ],
									"text" : "t 1 b"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 630.0, 424.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 629.0, 463.0, 32.0, 22.0 ],
									"text" : "t 4 b"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 0.0, 4.0, 150.0, 20.0 ]
												}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 34.0, 71.0, 512.0, 435.0 ],
																	"text" : "format :\npreset [modelAddress] preset-action args @attributes\n\neg.\n\npreset recall  (=> recall current active preset)\npreset recall toto (=> recall preset toto on top model)\npreset channel.1 recall \"demo preset\" (=> recall preset \"demo preset\" on sub-model channel.1)\n\npreset save\npreset channel.{1..5} save\n\npreset saveas\npreset channel.{1..3} saveas toto.{1..3} \npreset channel.{1..3} saveas toto.{1..3} @confirm 0\n\npreset delete\npreset delete toto.{1..3}\npreset channel.{1..3} delete toto.{1..3} @confirm 0\n\npreset rename\npreset rename toto.{1..3}\npreset rename toto.{1..3} zozo.{1..3}\npreset channel.{1..3} rename toto.{1..3} zozo.{1..3} @confirm 0\n\npreset interpolate \"demo preset\" 0.5 (=> interpolate between current preset and \"demo preset\")\npreset interpolate preset1 preset2 0.5\npreset channel.{1..3} interpolate preset-foo.{1..3} preset-bar.{1..3}  0.5\n\npreset reset\npreset reset toto.{1..3}\n"
																}
...
,
													"patching_rect" : [ 622.0, 500.0, 59.0, 22.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 35.0, 29.0, 512.0, 435.0 ],
																	"text" : "format :\npreset [modelAddress] preset-action args @attributes\n\neg.\n\npreset recall  (=> recall current active preset)\npreset recall toto (=> recall preset toto on top model)\npreset channel.1 recall \"demo preset\" (=> recall preset \"demo preset\" on sub-model channel.1)\n\npreset save\npreset channel.{1..5} save\n\npreset saveas\npreset channel.{1..3} saveas toto.{1..3} \npreset channel.{1..3} saveas toto.{1..3} @confirm 0\n\npreset delete\npreset delete toto.{1..3}\npreset channel.{1..3} delete toto.{1..3} @confirm 0\n\npreset rename\npreset rename toto.{1..3}\npreset rename toto.{1..3} zozo.{1..3}\npreset channel.{1..3} rename toto.{1..3} zozo.{1..3} @confirm 0\n\npreset interpolate \"demo preset\" 0.5 (=> interpolate between current preset and \"demo preset\")\npreset interpolate preset1 preset2 0.5\npreset channel.{1..3} interpolate preset-foo.{1..3} preset-bar.{1..3}  0.5\n\npreset reset\npreset reset toto.{1..3}\n"
																}
...
,
													"patching_rect" : [ 622.0, 466.0, 59.0, 22.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"globalpatchername" : "",
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 66.0, 133.0, 201.0, 22.0 ],
																	"text" : "preset mySubmodel recall myPreset"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 48.0, 102.0, 128.0, 22.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 50.0, 36.0, 233.0, 60.0 ],
...
, 															{
																"patchline" : 																{
																	...
																	"midpoints" : [ 395.5, 313.0, 435.5, 313.0, 435.5, 239.0, 59.5, 239.0 ],
																	"source" : [ "obj-54", 1 ]
																}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 895.0, 230.649777777777786, 363.0, 22.0 ],
													"text" : "preset channel.1/filter.{1..4} interpolate castor.{1..4} polux.{1..4} $1"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "preset {myBiquad|myLores} recall {biquad-preset|lores-preset}"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "preset channel.{1..2}/filter.{1..6} recall \"test preset ch{1..2}-filter{1..6}\""
												}
...
,
									"patching_rect" : [ 408.0, 319.561904761904771, 111.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 76.0, 514.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 51.0, 398.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 428.0, 44.0, 22.0 ],
									"text" : "uzi 3 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 76.0, 459.0, 87.0, 22.0 ],
									"text" : "setvalue $1 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 76.0, 487.0, 333.0, 22.0 ],
									"text" : "mvc.parameter subModelUID subModelParam @default 3.14"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 681.0, 532.0, 145.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 571.0, 578.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 629.0, 578.0, 71.0, 22.0 ],
									"text" : "mvc.remote"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 130.0, 249.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 75.0, 359.0, 335.0, 22.0 ],
									"text" : "mvc.model subModelUID modelUID subModel.2 @type woop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.0, 303.0, 99.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.0, 276.0, 183.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 74.0, 250.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 74.0, 217.0, 278.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 74.0, 152.0, 265.0, 22.0 ],
									"text" : "mvc.model modelUID toto myModel @type what"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 745.0, 157.0, 122.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 663.0, 16.0, 66.0, 22.0 ],
									"text" : "parent toto"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 745.0, 185.0, 51.0, 22.0 ],
									"text" : "address"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 745.0, 126.0, 103.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 735.0, 102.0, 127.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 719.0, 74.0, 43.0, 22.0 ],
									"text" : "parent"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 694.0, 46.0, 66.0, 22.0 ],
									"text" : "parent 123"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 783.585551330798467, 319.561904761904827, 88.0, 22.0 ],
									"text" : "parent myView"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 767.524714828897345, 296.37460317460318, 66.0, 22.0 ],
									"text" : "parent 123"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 751.463878326996223, 273.18730158730159, 66.0, 22.0 ],
									"text" : "parent toto"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 741.0, 250.0, 43.0, 22.0 ],
									"text" : "parent"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 560.0, 359.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 618.0, 359.0, 142.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 527.0, 139.0, 178.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 16.0, 80.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 74.0, 80.0, 261.0, 22.0 ],
									"text" : "mvc.parameter toto TestParam.2 @default 3.14"
								}
