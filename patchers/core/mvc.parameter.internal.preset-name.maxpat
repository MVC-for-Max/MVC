    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 3,
                    "outlettype": [ "", "", "" ],
                    "patching_rect": [ 148.0, 194.0, 200.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 148.0, 101.0, 152.0, 76.0 ],
                    "text": "patcherargs @mvc-type parameter @type string @description \"This model's preset name\" @default none @unit none"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 38.0, 189.0, 89.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 466.0, 377.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 393.0, 155.0, 56.0, 22.0 ],
                    "text": "route get"
                }
            },
            {
                "box": {
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "patching_rect": [ 50.0, 79.0, 184.50001066666675, 22.0 ],
                                                    "text": "sel bang 0"
                                                }
                                            },
                                            {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 1,
                                                    "outlettype": [ "" ],
                                                    "patching_rect": [ 50.00001066666675, 42.0, 30.0, 30.0 ]
                                                }
                                            }
                                        ],
                                        "lines": [
                    ...
                    "patching_rect": [ 393.0, 188.0, 40.0, 24.0 ],
                    "text": "p get"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 38.0, 317.0, 37.66666666666663, 22.0 ],
                    "text": "t l l"
                }
            },
            {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 20.666667, 80.0, 57.0, 22.0 ],
                                    "text": "tosymbol"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 20.666667, 120.0, 30.0, 30.0 ]
                                }
                            }
                        ],
                        "lines": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 3,
                    "numoutlets": 0,
                    "patching_rect": [ 56.66666666666663, 350.0, 207.0, 24.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 38.0, 253.0, 129.0, 24.0 ],
                    "text": "p receive"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 414.0, 377.0, 30.0, 30.0 ]
                }
            },
            {
                "box": {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-13", 0 ],
                    "midpoints": [ 338.5, 226.0, 374.09765625, 226.0, 374.09765625, 77.015625, 47.5, 77.015625 ],
                    "order": 1,
                    "source": [ "obj-44", 2 ]
                }
            },
