...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 349.0, 274.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 561.0, 208.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 684.0, 274.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 571.0, 138.0, 42.0, 22.0 ],
					"text" : "1000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 571.0, 169.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 286.5, 111.0, 45.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 111.0, 35.0, 22.0 ],
					"text" : "reset"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 89.0, 181.157168412982344, 194.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 89.0, 270.157168412982344, 34.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 89.0, 211.157168412982344, 29.5, 22.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 89.0, 298.157168412982344, 22.0, 22.0 ],
									"text" : "t 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 89.0, 243.157168412982344, 29.5, 22.0 ],
									"text" : "> 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "length" ],
									"patching_rect" : [ 89.0, 154.157168412982344, 48.0, 22.0 ],
									"text" : "t length"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 89.0, 383.550089445438232, 32.0, 22.0 ],
									"text" : "t b 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 89.0, 331.392921032455888, 52.0, 22.0 ],
									"text" : "gate 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 89.0, 424.628673651929375, 63.0, 22.0 ],
									"text" : "get values"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 89.0, 357.471505238947032, 34.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 122.0, 298.157168412982344, 61.0, 22.0 ],
									"text" : "dspstate~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 89.0, 450.707257858420519, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 111.5, 413.465755175057495, 73.0, 413.465755175057495, 73.0, 327.177740863787392, 98.5, 327.177740863787392 ],
									"source" : [ "obj-5", 1 ]
								}
